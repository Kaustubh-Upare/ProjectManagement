...
import { useGetDashboardStatsQuery, useGetDashboardStatsTasksQuery } from "../redux/api/api"
...
const Daashyboard=()=>{
  ...
  const {data:DashyStatsTask,isLoading:DashyStatsTaskLoading}=useGetDashboardStatsTasksQuery();
  console.log("jaat",DashyStatsTask)
  ...
  const statusCards = [
    { id: 1, title: "Total Task", count: DashyStatsTask?.TotalTasks},
    { id: 2, title: "Overdue", count: DashyStatsTask?.TotalOverdueTasks},
    { id: 3, title: "In Review", count: DashyStatsTask?.TotalTaskInReview },
    { id: 4, title: "In progress", count: DashyStatsTask?.TotalTaskInProgress },
    { id: 5, title: "Completed", count: DashyStatsTask?.TotalTaskCompleted},
    
  ]
  const TotalTasks=DashyStatsTask?.TotalTasks;
  const TotalCompletedTask=DashyStatsTask?.TotalTaskCompleted
  const Score=TotalTasks && TotalCompletedTask
  ? ((TotalCompletedTask / TotalTasks) * 100).toFixed(2)
  : 0;
  ...
  return (
    DashyStatsLoading || DashyStatsTaskLoading ? <LayoutLoader /> 
    :
    <Box
      sx={{
        padding: 3,
