...
import { useGetAdminTaskDashboardQuery } from "../../redux/api/adminApi"
...
const AdminDashboard=()=>{
  ...
  const {data:TaskyInfo,isLoading:loadingTaskyInfo}=useGetAdminTaskDashboardQuery();

  //  console.log("kaay bhoks vay be Part 2",DashyStats)
   console.log("kaay bhoks vay be",TaskyInfo)
            ...
            <CardContent>
              ...
              >
                <Typography sx={{ fontSize: "1.2rem", fontWeight: "bold", mb: 2 }}>Overall Progress</Typography>
                    ...
                    <GaugeChart perfo={TaskyInfo?.performance}/>
