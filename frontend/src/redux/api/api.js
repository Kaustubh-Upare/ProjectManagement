...
const api=createApi({
    ...
    endpoints:(builder)=>({
        ...
        getDashboardStatsTasks:builder.query({
            query:()=>({
                url:"dashyTasks",
                credentials:'include',
            })
        }),
        getSpecificProjectStatusCard:builder.query({
            query:(id)=>({
                url:`projects/specific/c/${id}`,
                credentials:'include',
            }),
            providesTags:['Projects']
        })
...
export const {
    ...
    useGetAdminDashboardStatsQuery,useGetAdminUserTasksQuery,useGetDashboardStatsTasksQuery,
    useGetSpecificProjectStatusCardQuery
}=api