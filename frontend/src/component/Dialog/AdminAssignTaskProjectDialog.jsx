...
import { useAdminAssignNewTaskMutation } from "../../redux/api/adminApi";


const AdminAssignTaskProjectDialog = ({ open,projectName ,projectId,onClose }) => {
...
//   const {user}=useSelector((state)=>state.auth)
  ...
  const[addTheTask,taskLoading]=useAsyncMutation(useAdminAssignNewTaskMutation)
...
export default AdminAssignTaskProjectDialog;
