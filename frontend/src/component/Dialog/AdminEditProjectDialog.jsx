...
import { useUpdateProjectAdminMutation } from "../../redux/api/adminApi";


const AdminEditProjectDialog = ({ open,projectName ,projectId,onClose }) => {
...
//   const {user}=useSelector((state)=>state.auth)
  ...
  const [EditProject,isLoadingEditProject]=useAsyncMutation(useUpdateProjectAdminMutation)
...
export default AdminEditProjectDialog;
