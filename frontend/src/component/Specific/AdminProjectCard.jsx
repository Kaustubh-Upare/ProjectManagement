...
const LazyAssignTaskDialog=lazy(()=>import('../Dialog/AdminAssignTaskProjectDialog'));
const statusColors = {
  "In Progress": "warning",
  "Backlog": "secondary",
  "In Review": "info",
...
const handleProjectStatus=async(e)=>{
  ...
  // }
  try {
    console.log("under functions", typeof projectId, typeof e.target.checked)
...
console.log(ProjectQuery)
  ...
  return (
    ...
    <Suspense>
      {openAssignDialog && <LazyAssignTaskDialog open={openAssignDialog} onClose={()=> setOpenAssignDialog(false)}
      projectId={projectId} projectName={ProjectFQuery?.name}
      />}
    </Suspense>
    ...
    <div style={{ padding: 20,width:"100%" }}>
      ...
      <Grid container spacing={2} alignItems="center" sx={{ mt: 2 }}>
        ...
        <Grid item>
          <Button variant="contained" color="primary" onClick={()=>setOpenAssignDialog(true)}>+ Assign Task</Button>
        </Grid>
      </Grid>
